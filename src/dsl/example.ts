...
export const packets: DataPacket[] = [
    { time: "2025-09-05T12:00:00Z", metrics: [{ cpu_usage: 42, mem_used: 7.1, net_in: 120, net_out: 80 }] },
    { time: "2025-09-05T12:00:05Z", metrics: [{ cpu_usage: 47, mem_used: 7.3, net_in: 150, net_out: 95 }] }
];

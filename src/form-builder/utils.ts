...
export function isObjectSchema(schema?: JSONSchema7): schema is JSONSchema7 & { type: "object" } {
    return schema?.type === "object" && !!schema.properties;
}

export function isArraySchema(schema?: JSONSchema7): schema is JSONSchema7 & { type: "array" } {
...
export function asJSONSchema(def?: JSONSchema7Definition): JSONSchema7 | undefined {
...
export function getMinMaxProps(schema?: JSONSchema7): { inputProps: Record<string, number | string> } {
